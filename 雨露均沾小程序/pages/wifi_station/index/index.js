...
Page({
  ...
  identifyimage: function () {
    var that = this;
    wx.uploadFile({
      url: 'http://188.131.196.191:8000', //换成自己的接口地址
        ...
        if (data.message !="OK"){
          ...
          if (str == "Hello World ") {
            ...
            const requestTask = wx.request({
              url: 'https://api.heclouds.com/devices/503191680/datapoints?datastream_id=Light,Temperature,Humidity&limit=10',
              header: {
                'content-type': 'application/json',
                'api-key': '6gyWGKvQxQrVG5xn5WK=s6BJyuA='
              },
              success: function (res) {
